import{r as d,h as e}from"./index.DfQGeXht.js";import"./framework.DWPVheDD.js";function b(a){return Object.entries(a).filter(([,n])=>!!n).map(([n,t])=>`${n}=${t}`).join("&")}function c(a){if(!a.startsWith("http"))return a;const n=new URL(a),t=n.pathname==="/"?"":n.pathname;return`${n.origin}${t}`}function f(a,n){let t;return function(...i){t||(t=setTimeout(()=>{t=null,a.apply(this,i)},n))}}const r={全部:"0",想看:"1",在看:"2",看过:"3",搁置:"4",抛弃:"5"},x={全部:"0",想玩:"1",在玩:"2",玩过:"3",搁置:"4",抛弃:"5"},p={全部:"0",想读:"1",在读:"2",读过:"3",搁置:"4",抛弃:"5"},u={动画:r,游戏:x,书籍:p,音乐:p,三次元:r},g={动画:"1",游戏:"2",书籍:"3",音乐:"4",三次元:"5"},h={动画:["全部","想看","在看","看过","搁置","抛弃"],游戏:["全部","想玩","在玩","玩过","搁置","抛弃"],书籍:["全部","想读","在读","读过","搁置","抛弃"],音乐:["全部","想听","在听","听过","搁置","抛弃"],三次元:["全部","想看","在看","看过","搁置","抛弃"]};async function v(a,n){const t=Object.assign(Object.assign({},n),{collectionType:r[n.collectionType]});return await(await fetch(`${c(a)}/bilibili?${b(t)}`)).json()}async function y(a,n){const{subjectType:t}=n,i=Object.assign(Object.assign({},n),{collectionType:u[t][n.collectionType],subjectType:g[n.subjectType]});return await(await fetch(`${c(a)}/bgm?${b(i)}`)).json()}async function j(a,n){const{subjectType:t}=n,i=Object.assign(Object.assign({},n),{collectionType:u[t][n.collectionType],subjectType:g[n.subjectType]});return await(await fetch(`${c(a)}/custom?${b(i)}`)).json()}function l({activeLabel:a,labels:n,containerState:t,onChange:i}){const o=s=>{a!==s&&i(s)};return e("div",{class:"bbc-tabs"},n.map(s=>e("div",{class:{"bbc-tab-item":!0,"bbc-tab-item-active":s===a,"bbc-md-tab-item":t!=="large"},key:s,onClick:()=>o(s)},s)))}function m(){return e("div",{class:"bbc-skeleton-container bbc-bangumi-item"},e("div",{class:"bbc-skeleton-avatar"}),e("div",{class:"bbc-skeleton-content bbc-bangumi-content"},e("div",{class:"bbc-skeleton-row",style:{width:"30%"}}),e("div",{class:"bbc-skeleton-row",style:{width:"60%",height:"40px"}}),e("div",{class:"bbc-skeleton-row",style:{width:"90%",height:"32px"}})))}const k=({containerState:a,labels:n})=>{let t=[...n];return a==="middle"&&(t=t.slice(0,4)),a==="small"&&(t=t.slice(0,3)),e("div",{class:"bbc-bangumi-labels"},t.map(i=>e("div",{class:{"bbc-bangumi-label":!0,"bbc-md-label-text":a!=="large"}},e("p",{class:"bbc-bangumi-label-title"},i.label),i.value&&e("p",null,i.value))))},w=({list:a,loading:n,containerState:t})=>e("div",{class:"bbc-bangumi"},a.map(i=>e("div",null,n?e(m,null):e("div",{class:"bbc-bangumi-item"},e("a",{href:i.url,target:"_blank",rel:"noreferrer"},e("img",{src:i.cover,alt:"cover",loading:"lazy",referrerpolicy:"no-referrer"})),e("div",{class:"bbc-bangumi-content"},e("h3",{class:"bbc-bangumi-title"},e("a",{href:i.url,target:"_blank",rel:"noreferrer",innerHTML:i.name?i.name:i.nameCN}),i.name&&e("small",{innerHTML:i.nameCN})),e(k,{containerState:t,labels:i.labels}),e("p",{class:"bbc-bangumi-summary",innerHTML:i.summary}))))));function C({pageNumber:a,totalPages:n,onChange:t,onInputChange:i}){return e("div",{class:"bbc-pagination"},e("a",{class:"bbc-pagination-button",onClick:()=>t("head")},"首页"),e("a",{class:"bbc-pagination-button",onClick:()=>t("prev")},"上一页"),e("span",{class:"bbc-pagination-pagenum"},`${a} / ${n}`),e("a",{class:"bbc-pagination-button",onClick:()=>t("next")},"下一页"),e("a",{class:"bbc-pagination-button",onClick:()=>t("tail")},"尾页"),e("div",{class:"bbc-pagination-input"},e("span",null,"跳至"),e("input",{type:"text",maxLength:4,onChange:i}),e("span",null,"页")))}function L(){return e("div",{class:"bbc-empty"},e("img",{src:"https://s1.hdslb.com/bfs/static/webssr/article/empty.png",alt:"empty",referrerpolicy:"no-referrer"}))}function T({error:a}){return e("div",{class:"bbc-error"},e("img",{src:"https://s1.hdslb.com/bfs/static/jinkela/long/bitmap/error_01.png",alt:"parse failed",referrerpolicy:"no-referrer"}),e("p",null,"Σ(oﾟдﾟoﾉ) 发生了一些错误"),e("p",null,`message: ${a.message}`))}const S=`@layer bilibili-bangumi-component {
  :host {
    display: block;
    /* 基础文本颜色 */
